...
Start 2P, Jersey 10, Pixelify Sans), its own concave-keycap or
convex-button depth rendering matched to what the real hardware actually
is, and its own procedurally-generated icon set (no icon file is shared
between any two themes in this repo) — see their screenshots and design
rationale in [`docs/VARIANTS.md`](docs/VARIANTS.md).
